...
while (bReachedGoal == false)
{
	string userMove;
	Console.WriteLine("Do you want to go N/E/S/W");
	userMove = Console.ReadLine().ToUpper();
	player.TryMoveTo(player.CurrentLocation.GetLocationAt(userMove));

	if (player.CurrentLocation.Name == "Goal")
		bReachedGoal = true;
